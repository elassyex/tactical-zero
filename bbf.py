...
def main():
    ...
    parser.add_argument("--model", default=os.getenv("AI_MODEL","gpt-4o"), help="AI model name")
    ...
    parser.add_argument("--ai-provider", default=os.getenv("AI_PROVIDER",""), choices=["openai","ollama","custom",""], help="AI provider")
    parser.add_argument("--ai-base-url", default=os.getenv("AI_BASE_URL",""), help="Custom AI base URL (OpenAI-compatible)")
    parser.add_argument("--ai-api-key", default=os.getenv("AI_API_KEY",""), help="Custom AI API key")
